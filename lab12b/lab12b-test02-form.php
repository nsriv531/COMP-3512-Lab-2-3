...
<body>
    ...
    <section class="grid-container">
        <?php
        // Loop to generate thumbnails of the images
        for ($i = 0; $i <= 9; $i++) {
            // Generate the thumbnail using the width query parameter
            echo "<img src='lab12b-test02.php?file={$i}&width=100' alt='Painting {$i}' />";
        }
        ?>
    </section>     
